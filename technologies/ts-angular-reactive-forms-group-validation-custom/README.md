...
##### Goal
The goal of this project is to present how to use **Reactive Forms with Group and Custom Validator** in an application type **GUI HTML** in **TypeScript** programming language with usage **angular** framework.
...
* **Reactive Forms with Group and Custom Validator**: this kind of forms should be used for more sophisticated forms in Angular. Group enables additional actions like validation. Custom Validator is implemented by developers.
